...
class PurchaseForm(FlaskForm):
    ...
    inputCantidad = IntegerField('Cantidad', validators=[InputRequired, Length(min=0, max=9, message="Valor máximo de 9 dígitos"), NumberRange(min=0, max=999999999, message='Valor no válido')])
